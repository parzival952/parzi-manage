...
// Mise en page de Parzi Manage (barre latérale, en-tête mobile, assistant IA
// flottant, navigation du bas). Déplacée depuis la racine : l'Academy n'hérite
// plus de rien de Manage. Les URL ne changent pas (groupe de routes).
const nav = [
